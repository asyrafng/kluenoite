...
rpm-ostree override remove $INSTALLED_KERNEL_PACKAGES --install=kernel-cachyos-bore-eevdf kernel-cachyos-bore-eevdf-devel-matched kernel-cachyos-bore-eevdf-devel
